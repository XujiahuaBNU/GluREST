...
def get_centrality_by_rvalue(ts_normd,
    ...
    # Import packages
    from network.utils import cluster_data
    from network.core import degree_centrality, eigenvector_centrality
...
def get_centrality_fast(timeseries,
    ...
    from network.core import fast_degree_centrality, fast_eigenvector_centrality
    from network.utils import norm_cols
    try:
        out_list    = []
